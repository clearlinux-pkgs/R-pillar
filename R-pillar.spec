...
Source0  : https://cran.r-project.org/src/contrib/pillar_1.6.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618329689
...
/usr/lib64/R/library/pillar/doc/digits.R
...
/usr/lib64/R/library/pillar/tests/testthat/test-tibble-opt.R
